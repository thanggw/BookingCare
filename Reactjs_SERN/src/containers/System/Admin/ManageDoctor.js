...
class ManageDoctor extends Component {
  ...
  buildDataInputSelect = (inputData, type) => {
    //cần khai báo hàm này vì thư viện Select cần 2 biến label và value
    let result = [];
  ...
  handleSaveContentMarkdown = () => {
    ...
    console.log("check request: ", this.state);
      ...
      <div className="manage-doctor-container">
        ...
        <div className="more-infor">
          ...
          <div className="content-right">
            ...
            <textarea
              ...
              onChange={(event) =>
                this.hangleOnchangeText(event, "description")
              }
        ...
        <div className="more-infor-extra row">
          ...
          <div className="col-4 form-group">
            ...
            <input
              className="form-control"
              onChange={(event) => this.hangleOnchangeText(event, "nameClinic")}
          ...
          <div className="col-4 form-group">
            ...
            <input
              className="form-control"
              onChange={(event) =>
                this.hangleOnchangeText(event, "addressClinic")
              }
          ...
          <div className="col-4 form-group">
            ...
            <input
              className="form-control"
              onChange={(event) => this.hangleOnchangeText(event, "note")}
